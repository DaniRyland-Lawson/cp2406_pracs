...
including at least a toString() method. Test your class with a short program that
counts how many times a pair of dice is rolled, before the total of the two dice is equal to two.
 */
...
public class PairOfDice {
    ...
    public String toString() {
        return " toString: die2 = " + die1 + ", die2 =" + die2;
    }
    ...
    public void roll() {
        ...
        sum = die1 + die2;
        System.out.println("die = " + die1 + ", die2 =" + die2);
    }
