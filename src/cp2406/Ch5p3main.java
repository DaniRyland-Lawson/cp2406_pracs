...
You can use a new pair of dice if you want, but it's not required.)
 */
...
public class Ch5p3main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total On Dice     Average Number of Rolls        Mean            StdDeviation");
        System.out.println("-------------     -----------------------       ------           ------------");
        for ( int dice = 2;  dice <= 12;  dice++ ) {
            StatCalc calc = getRollStats( dice );
            System.out.printf(
                    "%10d%22.4f%22.4f%22.4f\n",
                    dice, calc.getMean(),
...
//        double averageRollCount = calc.getMean();
